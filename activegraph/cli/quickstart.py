...
def _print_what_just_happened(write) -> None:
    ...
    write("     llm.responded events and serves them back on fork or replay —")
    write("     that's where `cache_hit=true` appears in the trace. Different")
    write("     layer; you'll see it if you fork this run.)")
    write("")
